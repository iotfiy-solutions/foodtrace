    ...
    <div className="relative">
      <ResponsiveContainer width="100%" >
        <div className="w-full">
              ...
              {open && (
                <div className="absolute right-0 mt-10 w-44 bg-white rounded-xl shadow-lg border border-gray-200 z-50 overflow-hidden animate-fadeIn">
                  <button
                    ...
                    className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-100 ${mode === "battery" ? "bg-gray-100 font-medium" : ""
                      }`}
                  >
                    Battery Low
                  </button>
                  ...
                  <button
                    ...
                    className={`w-full text-left px-4 py-2 text-sm hover:bg-gray-100 ${mode === "refrigerator" ? "bg-gray-100 font-medium" : ""
                      }`}
                  >
                    Need Maintenance
                  </button>
          ...
          {/* E. Analytics Chart (new design) */}
          <div className="relative mt-3 mb-3 md:mb-0  h-[10rem] md:h-[6.4rem] 2xl:h-[8rem] ">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                // tiny remount trick so Recharts updates reliably when mode changes
                key={`alerts-chart-${mode}`}
